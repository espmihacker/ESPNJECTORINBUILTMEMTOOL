...
public class FloatLogo extends Service implements View.OnClickListener {
    ...
    void Init(){
        ...
        final CheckBox isIpad = mFloatingView.findViewById(R.id.isIpad);
        isIpad.setChecked(getConfig((String) isIpad.getText()));
        SettingValue(3,getConfig((String) isIpad.getText()));
        isIpad.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                setValue(String.valueOf(isIpad.getText()), isIpad.isChecked());
                SettingValue(11,isIpad.isChecked());
            }
        });
